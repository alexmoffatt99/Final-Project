...
const cacheName = 'Casey_Kerin_Moffatt2-2020-04-30 22:13:38.949581'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Casey_Kerin_Moffatt2'.length) === 'Casey_Kerin_Moffatt2') {
